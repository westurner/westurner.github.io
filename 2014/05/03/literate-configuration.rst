...
.. _bashrc docs: http://wrdfiles.readthedocs.org/en/latest/usage.html#bash   
.. _vimrc: https://github.com/westurner/dotvim/blob/master/vimrc
.. _vimrc docs: http://wrdfiles.readthedocs.org/en/latest/usage.html#vim
.. _`.i3/config`: https://github.com/westurner/dotfiles/blob/master/etc/.i3/config   
.. _`.i3/config docs`: http://wrdfiles.readthedocs.org/en/latest/usage.html#i3wm   
...
.. _my keyboard shortcuts: http://wrdfiles.readthedocs.org/en/latest/usage.html#dotfiles-makefile   
